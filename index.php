...
<html>
	...
	<body>
		<div align="right" style="padding: 5px;">
			<a href="loginad.php">ผู้ดูแลระบบ</a>
		</div>
		<center><img style="padding-top: 10%;" src="1.png" width="15%"></center>
		<p align="center" style="line-height: 1.2em;; font-size: 2em; margin-top: 2%; color: white; text-shadow: 1px 1px 1px black;">ศูนย์เทคโนโลยีสารสนเทศและการสื่อสาร สำนักงานปลัดกระทรวงสาธารณสุข<br>ระบบบันทึกเวลา เข้า-ออกงาน</p>
		<div class="clock">
			<p>
